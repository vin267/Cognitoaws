...
login = CognitoClient()
print(login.login('vineet27091991@gmail.com','Testing#1234'))

#forgotpassword = CognitoClient()
#print(forgotpassword.forgot_password('vineet99583@gmail.com'))

#logout = CognitoClient()
#print(logout.logout('eyJraWQiOiJQM21VZXhnZ2xLMmR1MUR0R3lZWFZ3NUtCRkNJaUprUHNmQVdoNHBLTERRPSIsImFsZyI6IlJTMjU2In0..hsib7aOYwocLracTq2Su0h36aIFoSbhFJ5bUYUs16MXTnI4LmaYjOBNjKdnOyahbz7d8_lzh6nJ9xrrXGSgA4gxcxX1vhhHlq_skdNZ7IK5V93FXSVwxWdlQFZo6y-zMr-38GrUuvYVbHc6FOp7f5uvdefh32j1sdGDpeOuSK8qFzPVEALYX1lI0ajhTLp3OtOdprZn4Vu5TqGac5H3NzSfLM_97_KFPX0j91JzkjZr2h2vIW5E5hIRtRvL6fGmBqwgmS6i_kdVWTlWBd3KmL5RduG0sHU0r28uyJCpBbO1XrghtrP9knYkA07MBwaQZSkjQFm0ORZXExUdT-WvrdA'))

#getuser = CognitoClient()
#print(getuser.get_user('eyJraWQiOiJQM21VZXhnZ2xLMmR1MUR0R3lZWFZ3NUtCRkNJaUprUHNmQVdoNHBLTERRPSIsImFsZyI6IlJTMjU2In0..tK5jMleJo6jYv-Eb-WTQ3-QyVQbh2opmbPtVXCXsX4F4_P0khiA4x3c5sigHYPeiH4UpBAxOoLti5wmRuN_aAv5avofbDBpRgHgL7QD1ClNTd2efraHbGksWqjN1se78SLHodCIL57Euoul4BG-PXxMuBzoVpkecNs_btK5Wfntto2AqTneW8e8yxNCSeXM7L3GvxLdNNzOZQNRXj7phshYdPOjaa4HNZt0MMNuDnwhOmJAiVTpkDEHP3T30ZlirR64_mCkOn_zK5G7IRm9OqgMzPk-8gMpZn1aD7lBmD6fLpqxkcJFsl2rUJNvRLx1T7ZLYEzFVR2cv_FzeQWfIxg'))

#changepassword = CognitoClient()
#print(changepassword.change_password('eyJraWQiOiJQM21VZXhnZ2xLMmR1MUR0R3lZWFZ3NUtCRkNJaUprUHNmQVdoNHBLTERRPSIsImFsZyI6IlJTMjU2In0..tK5jMleJo6jYv-Eb-WTQ3-QyVQbh2opmbPtVXCXsX4F4_P0khiA4x3c5sigHYPeiH4UpBAxOoLti5wmRuN_aAv5avofbDBpRgHgL7QD1ClNTd2efraHbGksWqjN1se78SLHodCIL57Euoul4BG-PXxMuBzoVpkecNs_btK5Wfntto2AqTneW8e8yxNCSeXM7L3GvxLdNNzOZQNRXj7phshYdPOjaa4HNZt0MMNuDnwhOmJAiVTpkDEHP3T30ZlirR64_mCkOn_zK5G7IRm9OqgMzPk-8gMpZn1aD7lBmD6fLpqxkcJFsl2rUJNvRLx1T7ZLYEzFVR2cv_FzeQWfIxg','Test@1234','Testing@1234'))

#adminlistuser = CognitoClient()
#print(adminlistuser.admin_list_users())

#admindisableuser = CognitoClient()
#print(admindisableuser.admin_disable_user('vineet99583@gmail.com'))

#adminenableuser = CognitoClient()
#print(adminenableuser.admin_enable_user('vineet99583@gmail.com'))

#adminlistgroupforuser = CognitoClient()
#print(adminlistgroupforuser.admin_list_groups_for_user('vineet99583@gmail.com'))

#getclient = CognitoClient()
#print(getclient._CognitoClient__get_client())

#signup = CognitoClient()
#print(signup.sign_up('vineet27091991@gmail.com', 'Abc@1234', email='vineet27091991@gmail.com', given_name='lebron', family_name='james'))

#confirmsignup = CognitoClient()
#print(confirmsignup.confirm_sign_up('vineet27091991@gmail.com', '333004'))

#forgotpassword = CognitoClient()
#print(forgotpassword.forgot_password('vineet27091991@gmail.com'))

#confirmforgotpassword = CognitoClient()
#print(confirmforgotpassword.confirm_forgot_password('vineet27091991@gmail.com','023660','Testing#1234'))
